'''
Title:          myrouter_part2
Description:    Project 2, part 2 - Add IP Port forwarding to the router built in part 1
...
Description:    Implements a basic forwarding table
...
class ForwardingTable:
    ...
    '''
    add_entry
    Adds a new entry to the forwarding table
    Parameters:
    ...
    '''
    def add_entry(self, network, next_hop, port):
        log_debug("FT: Add: {}, {}, {}".format(str(network), str(next_hop), str(port)))
    ...
    def load_file(self, filename):
        ...
        try:
            ...
            for line in fh.readlines():
                ...
                self.add_entry(network, next_hop, mac_addr)
                fh.close()
        except:
